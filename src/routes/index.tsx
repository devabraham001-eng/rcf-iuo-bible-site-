...
const PASSAGES: PassageData[] = [
  {
    reference: "1 John 4 (KJV)",
    verses: [
      { book: "1 John", chapter: 4, verse: 1, text: "Beloved, believe not every spirit, but try the spirits whether they are of God: because many false prophets are gone out into the world." },
      { book: "1 John", chapter: 4, verse: 2, text: "Hereby know ye the Spirit of God: Every spirit that confesseth that Jesus Christ is come in the flesh is of God:" },
      { book: "1 John", chapter: 4, verse: 3, text: "And every spirit that confesseth not that Jesus Christ is come in the flesh is not of God: and this is that spirit of antichrist, whereof ye have heard that it should come; and even now already is it in the world." },
      { book: "1 John", chapter: 4, verse: 4, text: "Ye are of God, little children, and have overcome them: because greater is he that is in you, than he that is in the world." },
      { book: "1 John", chapter: 4, verse: 5, text: "They are of the world: therefore speak they of the world, and the world heareth them." },
      { book: "1 John", chapter: 4, verse: 6, text: "We are of God: he that knoweth God heareth us; he that is not of God heareth not us. Hereby know we the spirit of truth, and the spirit of error." },
      ...
      { book: "1 John", chapter: 4, verse: 9, text: "In this was manifested the love of God toward us, because that God sent his only begotten Son into the world, that we might live through him." },
      { book: "1 John", chapter: 4, verse: 10, text: "Herein is love, not that we loved God, but that he loved us, and sent his Son to be the propitiation for our sins." },
      { book: "1 John", chapter: 4, verse: 11, text: "Beloved, if God so loved us, we ought also to love one another." },
      { book: "1 John", chapter: 4, verse: 12, text: "No man hath seen God at any time. If we love one another, God dwelleth in us, and his love is perfected in us." },
      { book: "1 John", chapter: 4, verse: 13, text: "Hereby know we that we dwell in him, and he in us, because he hath given us of his Spirit." },
      { book: "1 John", chapter: 4, verse: 14, text: "And we have seen and do testify that the Father sent the Son to be the Saviour of the world." },
      { book: "1 John", chapter: 4, verse: 15, text: "Whosoever shall confess that Jesus is the Son of God, God dwelleth in him, and he in God." },
      ...
      { book: "1 John", chapter: 4, verse: 17, text: "Herein is our love made perfect, that we may have boldness in the day of judgment: because as he is, so are we in this world." },
      ...
      { book: "1 John", chapter: 4, verse: 20, text: "If a man say, I love God, and hateth his brother, he is a liar: for he that loveth not his brother whom he hath seen, how can he love God whom he hath not seen?" },
      { book: "1 John", chapter: 4, verse: 21, text: "And this commandment have we from him, That he who loveth God love his brother also." },
    ],
  },
  {
